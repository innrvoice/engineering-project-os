...
The Project OS software and documentation are provided under the repository's [MIT License](../LICENSE). These terms do not replace or restrict rights granted by that license.
...
Project OS is provided without warranties or guarantees, as described in the MIT License. Users remain responsible for reviewing and testing changes before relying on them.

## Changes and contact

Material changes to these terms will be published in this repository with an updated effective date. Questions can be filed through [GitHub Issues](https://github.com/innrvoice/engineering-project-os/issues).
